...
## 1. Назначение
«MUIVesg» — учебный проект ВКР: обмен/передача вещей, пожертвования, переработка и утилизация с рекомендациями. Есть веб‑интерфейс (Flask) и REST API, далее планируется десктоп‑клиент PySide6.
